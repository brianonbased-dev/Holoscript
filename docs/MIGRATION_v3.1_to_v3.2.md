# Migration Guide: HoloScript v3.1.x → v3.2.0

This guide covers upgrading from HoloScript v3.1.x to v3.2.0 (Autonomous Agent Swarms).

---

## Overview

HoloScript v3.2.0 introduces the **Swarm Module** - a comprehensive system for coordinating autonomous agent collectives. This is an additive release with no breaking changes to existing v3.1.x APIs.

| Category | v3.1.x | v3.2.0 |
|----------|--------|--------|
...
```typescript
// v3.1.x - Manual agent coordination
...
Your existing v3.1.x code should work without changes:
...
| v3.1.x Pattern | v3.2.0 Replacement |
|----------------|-------------------|
...
**None.** No v3.1.x APIs are deprecated.
