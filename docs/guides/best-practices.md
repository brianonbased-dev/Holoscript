...
- **Network Efficient**: Use `@networked` only for objects that *must* be synced between users. Unnecessary syncing kills bandwidth.
...
- **Affordance**: An object that looks grabbable (like a handle) should *be* grabbable.
