...
This guide covers migrating from HoloScript v3.0.x to v3.1.0 (Agentic Choreography).

---

## Overview

v3.1.0 introduces the **Agentic Choreography** system - a comprehensive multi-agent orchestration framework. This release is **backward compatible** with v3.0.x, with new features being additive.
...
**None.** v3.1.0 is fully backward compatible with v3.0.x.
...
The standalone `HITLTrait` from v3.0.x continues to work but is now better used through the Choreography Engine for complex workflows.
...
**v3.1.0 (recommended for workflows):**
```typescript
...
All v3.0.x code continues to work. Remove any v3.1 imports if you added them.
