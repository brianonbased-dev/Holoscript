...
export class HoloHubTreeDataProvider implements vscode.TreeDataProvider<HoloSmartAssetItem> {
    ...
    private _onDidChangeTreeData: vscode.EventEmitter<HoloSmartAssetItem | undefined | null | void> = new vscode.EventEmitter<HoloSmartAssetItem | undefined | null | void>();
    readonly onDidChangeTreeData: vscode.Event<HoloSmartAssetItem | undefined | null | void> = this._onDidChangeTreeData.event;
...
export class HoloSmartAssetItem extends vscode.TreeItem {
    constructor(
        public readonly asset: HoloSmartAsset
    ) {
