...
export class InputManager {
  ...
  setupVR(renderer: THREE.WebGLRenderer) {
     ...
     controller0.addEventListener('selectstart', () => this.onSelectStart('hand_right', controller0));
  ...
  onSelectStart(source: 'mouse' | 'hand_left' | 'hand_right', controller?: THREE.Object3D) {
  ...
  update() {
    ...
    const hit = intersects.find(i => i.object.userData.grabbable || i.object.userData.interactable || i.object.userData.holoObject);
  ...
  private dispatch(type: InputEvent['type'], object: THREE.Object3D, source: InputEvent['source'], point?: THREE.Vector3) {
