...
describe('CollectiveIntelligence', () => {
  ...
  describe('contribute', () => {
    ...
    it('should throw if agent not a participant', () => {
      ...
      expect(() => service.contribute(session.id, {
        agentId: 'outsider',
        type: 'idea',
    ...
    it('should support all contribution types', () => {
      ...
      const idea = service.contribute(session.id, { agentId: 'agent-1', type: 'idea', content: 'Idea', confidence: 0.8 });
      const critique = service.contribute(session.id, { agentId: 'agent-1', type: 'critique', content: 'Critique', confidence: 0.7 });
      const consensus = service.contribute(session.id, { agentId: 'agent-1', type: 'consensus', content: 'Consensus', confidence: 0.9 });
      const solution = service.contribute(session.id, { agentId: 'agent-1', type: 'solution', content: 'Solution', confidence: 0.95 });
  ...
  describe('vote', () => {
    ...
    it('should throw if voter is not a participant', () => {
      ...
      expect(() => service.vote(session.id, contribution.id, 'outsider', 'support')).toThrow('not a participant');
    });
  });
  ...
  describe('synthesize', () => {
    it('should return empty result with too few contributions', () => {
      ...
      service.contribute(session.id, { agentId: 'agent-1', type: 'idea', content: 'Single idea', confidence: 0.8 });
    ...
    it('should synthesize contributions', () => {
      ...
      service.contribute(session.id, { agentId: 'agent-1', type: 'idea', content: 'First idea', confidence: 0.8 });
      service.contribute(session.id, { agentId: 'agent-1', type: 'idea', content: 'Second idea', confidence: 0.9 });
  ...
  describe('getTopContribution', () => {
    it('should return highest voted contribution', () => {
      ...
      const c1 = service.contribute(session.id, { agentId: 'agent-1', type: 'idea', content: 'Idea 1', confidence: 0.8 });
      const c2 = service.contribute(session.id, { agentId: 'agent-2', type: 'idea', content: 'Idea 2', confidence: 0.9 });
  ...
  describe('getSessionStats', () => {
    it('should compute session statistics', () => {
      ...
      service.contribute(session.id, { agentId: 'agent-1', type: 'idea', content: 'Idea', confidence: 0.8 });
      service.contribute(session.id, { agentId: 'agent-1', type: 'solution', content: 'Solution', confidence: 0.9 });
  ...
  describe('getAgentContributions', () => {
    it('should filter contributions by agent', () => {
      ...
      service.contribute(session.id, { agentId: 'agent-1', type: 'idea', content: 'A1 idea', confidence: 0.8 });
      service.contribute(session.id, { agentId: 'agent-2', type: 'idea', content: 'A2 idea', confidence: 0.9 });
      service.contribute(session.id, { agentId: 'agent-1', type: 'critique', content: 'A1 critique', confidence: 0.7 });
